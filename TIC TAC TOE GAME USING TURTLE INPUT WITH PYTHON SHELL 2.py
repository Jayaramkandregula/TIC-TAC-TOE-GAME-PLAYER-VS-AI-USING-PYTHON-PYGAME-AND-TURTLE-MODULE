...
bgcolor("black");pensize(20);speed(100);hideturtle();setup(800,700)
...
def drawboard():
    ...
    pensize(8)
    color("red")
    up();goto(-290,290);down();write(11,font=("calibri",12,"bold"));up();goto(-90,290);down();write(12,font=("calibri",12,"bold"));up();goto(110,290);down();write(13,font=("calibri",12,"bold"))
    up();goto(-290,80);down();write(21,font=("calibri",12,"bold"));up();goto(-90,80);down();write(22,font=("calibri",12,"bold"));up();goto(110,80);down();write(23,font=("calibri",12,"bold"))
    up();goto(-290,-120);down();write(31,font=("calibri",12,"bold"));up();goto(-90,-120);down();write(32,font=("calibri",12,"bold"));up();goto(110,-120);down();write(33,font=("calibri",12,"bold"))
def pos1(ch):
    ...
    for n in range(9):
        if(n%2==0):
            ...
            if(check==1):
                ...
                up();goto(-300,320);down();color("white");write("Congratulations %s!You have won the match"%(P1),font=("arial",15,"bold"))
                break
        else:
            ...
            if(check==1):
                strike(comboposition)
                up();goto(-300,320);down();color("white");write("Congratulations %s!You have won the match"%(P2),font=("arial",15,"bold"))
                break
    else:
        up();goto(-300,320);down();color("white");write("The match is drawn!",font=("arial",15,"bold"))
if(mode=='2'):
    ...
    if(level=='1'):
        ...
        for n in range(9):
            if(n%2==0):
                ...
                if(check==1):
                    strike(comboposition)
                    up();goto(-300,320);down();color("white");write("Congratulations %s!You have won the match"%(P),font=("arial",15,"bold"))
                    break
            else:
                ...
                if(check==1):
                    strike(comboposition)
                    up();goto(-300,320);down();color("white");write("MY AI %s has won the match"%(myAI),font=("arial",15,"bold"))
                    break
        else:
            up();goto(-300,320);down();color("white");write("The match is drawn!",font=("arial",15,"bold"))
    elif(level=='2'):
